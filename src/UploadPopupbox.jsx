...
return(
    <div  className={"  backdrop-blur-3xl  text-center fixed w-10/11 shadow-2xl/10 h-13/16 lg:h-3/4 bg-pink-300/40  border border-white/20 inset-0 m-auto rounded-4xl z-50 "}>
        ...
        <form onSubmit={formSubmitHandler} className={" w-full h-full"}>
            ...
            <h1 className={"font-mono  mt-5 text-2xl text-gray-200 text-center"}>Upload your Art!</h1>

            <input type="file" onChange={fileLabelChange}  className={"hidden"} id="fileUpload"/>
            <label className={" flex flex-col justify-center items-center  text-2xl font-sans text-gray-400  text-center bg-slate-900/50 rounded-2xl border-dashed  mt-20  mx-auto w-3/4 h-2/3 border-2 border-gray-600 "} htmlFor="fileUpload">

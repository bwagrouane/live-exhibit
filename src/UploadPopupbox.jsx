...
return(
    <div  className={"  backdrop-blur-3xl  text-center fixed w-10/11 shadow-2xl/10 h-13/16 lg:h-5/6 bg-pink-300/40  border border-white/20 inset-0 m-auto rounded-4xl z-50 "}>
        ...
        <form onSubmit={formSubmitHandler} className={" w-full h-full"}>
            ...
            <label className={" flex flex-col justify-center items-center  text-2xl font-sans text-gray-400  text-center bg-slate-900/50 rounded-2xl border-dashed  mt-8 mb-2 mx-auto w-3/4 h-2/3 border-3 border-gray-700 "} htmlFor="fileUpload">
